<template>
  <div>
    <div class="home_user_header">
      <h3 class="comman-title">{{ $q.lang.phqAnswer.title }}</h3>
    </div>
    <div class="q-pa-md main-wrapper">
      <div class="custom-tabel-box">
        <table-component
          ref="tableRefresh"
          :apiUrl="PHQ_ANSWER.LIST"
          title="Phq_Answer"
          :columns="columns"
          rowKey="id"
          createUrl="/phq-9-answer/create"
